...
if(isset($_POST['log'])){
    ...
    $result = $sql->execute();
    if($result){
        $sql1 = $conn->prepare("select * from register where email = ?");
        $result1 = $sql1->execute([$email]);
        $rowEmail = $sql1->rowCount();
        if($rowEmail == 1){
            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        <a href="user-profile.html"><span></span></a>
                        <a href="order.html"><span></span></a>
                        <a href="faq.html"><span></span></a>
                    </div>
            ...
            <div class="login-section">
                <div class="review-form">
                    ...
                    <div class="login-btn text-center">
                        ...
                        <input type="submit" class="shop-btn" value="Log In" name="log">
                        <span class="shop-account">Dont't have an account ?<a href="create-account.php">Sign Up
                                Free</a></span>
                    </div>
                </div>
            </div>
