...
if(isset($_SESSION['login'])){
    ...
    // echo "idan";
    // foreach($login_session as $login_session){
    //     foreach($index1 as $index1){
    //         echo $login_session." & ".$index1;
    //     }
    // }
}
...
if(isset($_POST['cart'])){
    if(isset($_SESSION['login'])){
        ...
        $result = $sql->execute();
        if($result){
            $sql1 = $conn->prepare("select * from cart where image_name = ?");
            $result1 = $sql1->execute([$imageFilename]);
            $row_image = $sql1->rowCount();
            if($row_image <= 0){
                $sql2 = $conn->prepare("insert into cart(client_id,cloth,price,image_name) values(?,?,?,?)");
                $result2 = $sql2->execute([$id_session,$cloth,$price,$imageFilename]);
                if($result2){
                    header("location: index.php");
                }
            }else{
                $error_num[] = "Selected detail already added in cart";
            }
        }else{
            echo "server error";
            die();
...
if(isset($_POST['remove'])){
    ...
    $sql5 = $conn->prepare("delete from cart where client_id = ? and image_name = ?");
    $result5 = $sql5->execute([$id,$name]);
    if($result5){
        header("location: index.php");
    }
}
...
if(isset($_POST['view_cart'])){
    if(isset($_SESSION['login'])){
        ...
        header("location: cart.php?session=$session&id=$id_view");
            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        ...
                        <a href="checkout.php"><span>Track Order</span></a>
                    </div>
                    <div class="header-contact d-none d-lg-block">
                        <a href="#">
                            <span>Need help? Call us:</span>
                            <span class="contact-number">255689000000</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-cart">
                            <a href="" class="cart-item">
                                <span>(
                                    ...
                                    if(isset($_SESSION['login'])){
                                    $id = $_SESSION['id'];
                                    $sql3 = $conn->prepare("select * from cart where client_id = ?");
                                    $result3 = $sql3->execute([$id]);
                                    $row = $sql3->rowCount();
                                    echo $row;
                                    }else{
                                        $empty = 0;
                            ...
                            <div class="cart-submenu">
                                ...
                                $id_cart = $_SESSION['id'];
                                $sql4 = $conn->prepare("select * from cart where client_id = ?");
                                $result4 = $sql4->execute([$id_cart]);
                                
                                while($fetch = $sql4->fetch(PDO::FETCH_ASSOC)){
                                
                                ?>
                                    <div class="wrapper">
                                        <div class="wrapper-item">
                                            <div class="wrapper-img">
                                                <img src="assets/images/core/product-img/<?=  $fetch['image_name'] ?>"
                                                    alt="img">
                                            </div>
                                            <div class="wrapper-content">
                                                <h5 class="wrapper-title"><?=  $fetch['cloth'] ?></h5>
                                                <div class="price">
                                                    <p class="new-price"><?=  $fetch['price'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <span class="close-btn">
                                            ...
                                            <input type="hidden" name="name" value="<?= $fetch['image_name'] ?>">
                                            <input type="hidden" name="id_re" value="<?= $fetch['client_id'] ?>">
                                            <input type="submit" value="remove" style="padding:4px;border-radius:5px;" name="remove">
                                            </form>
                                        </span>
                                    </div>
                                    <?php
                                    $grant_total += $fetch['price'];
                                    }
                                }
                                ...
                                <div class="cart-wrapper-section">
                                    ...
                                    <div class="wrapper-subtotal">
                                        ...
                                        <h5 class="wrapper-title"><?php echo $grant_total;  ?></h5>
                                    </div>
                                    <div class="cart-btn">
                                        <form action="" method="post">
                                        <input type="submit" class="shop-btn view-btn" value="View Cart" name="view_cart">
                        ...
                        <div class="header-user">
                            <a href="user-profile.php?session=<?php if(isset($_SESSION['login'])){
                                $session_profile = "login";
                                echo $session_profile;
                            } ?>&id=<?php if(isset($_SESSION['login'])){ 
                                ...
                                <span>
                                    ...
                                    if(isset($_SESSION['login'])){
                                        $id_name = $_SESSION['id']; 
                                        $sql6 = $conn->prepare("select * from register where id = ?");
                                        $result6 = $sql6->execute([$id_name]);
                                        if($result6){
                                            $fetch1 = $sql6->fetch(PDO::FETCH_ASSOC);

                                            echo $fetch1['fname']." ".$fetch1['lname']; 
                                        }
                                    }
            ...
            <div class="container">
                <div class="header-nav">
                                ...
                                <div class="shop-menu">
                                    <div class="menu-wrapper">
                                        <div class="menu-list">
                                            ...
                                            <ul>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">Shirt</a></li>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                    if(!isset($login_session)){
                                                    echo "INlogin";
                                                    }
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">Skart</a></li>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                    if(!isset($login_session)){
                                                    echo "INlogin";
                                                    }
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>"> T-Shirt</a></li>
                                            </ul>
                                        </div>
                                        <div class="menu-list">
                                            ...
                                            <ul>
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">HandBags</a></li>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                    if(!isset($login_session)){
                                                    echo "INlogin";
                                                    }
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">Mobile Bags</a></li>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                    if(!isset($login_session)){
                                                    echo "INlogin";
                                                    }
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">School Bags</a></li>
                                            </ul>
                                        </div>
                                        <div class="menu-list">
                                            ...
                                            <ul>
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">Liptics</a></li>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                    if(!isset($login_session)){
                                                    echo "INlogin";
                                                    }
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>">Foundation</a></li>
                                                <li><a href="product-sidebar.php?session=<?php if(isset($login_session) || isset($index1)){
                                                    if(!isset($login_session)){
                                                    echo "INlogin";
                                                    }
                                                ...
                                                }?>&id=<?php  echo $id_sesion;  ?>"> Eye Liner</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="shop-menu-img">
                                        <img src="./assets/images/core/img13.jpeg" alt="img">
                                    </div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="result">
                        ...
                        <p style="color:black;"><span><?php if(isset($error_num)){foreach($error_num as $error_num) {
                                echo $error_num;
                             } 
                        }?></span></p>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="wrapper-section" data-aos="fade-up">
                                <div class="wrapper-info">
                                    <h5 class="wrapper-subtitle">UP TO <span class="wrapper-inner-title">50%</span> OFF
                                    </h5>
                                    <h1 class="wrapper-details">Fashion Collection
                                        Summer Sale</h1>
                                    <a href="#" class="shop-btn">Express</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right">
                            <div class="wrapper-info">
                                ...
                                <h4 class="wrapper-details">Get 50% Offer
                                    <span class="wrapper-inner-title">& Make New</span> Fusion.
                                </h4>
                                <a href="" class="shop-btn">Feel Free
                                    <span>
            ...
            <div class="arrival-section">
                <div class="row g-5">
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic1.jpg"
                                    alt="product-img">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Black Cadet
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Black Cadet">
                                <input type="hidden" name="Price" value="6.99">
                                <input type="hidden" name="imageFilename" value="pic1.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic2.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Smooth Cadet
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                 <form action="" method="post">
                                <input type="hidden" name="cloth" value="Smooth Cadet">
                                <input type="hidden" name="Price" value="6.99">
                                <input type="hidden" name="imageFilename" value="pic2.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic3.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Vicross Green Cadet
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Vicross Green Cadet">
                                <input type="hidden" name="Price" value="10.99">
                                <input type="hidden" name="imageFilename" value="pic3.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img22.jpeg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Red sandals
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Red sandals">
                                <input type="hidden" name="Price" value="10.99">
                                <input type="hidden" name="imageFilename" value="img22.jpeg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic5.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Vicross cadet
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$20.99</span>
                                        <span class="new-price">$10.99</span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Vicross cadet">
                                <input type="hidden" name="Price" value="10.99">
                                <input type="hidden" name="imageFilename" value="pic5.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/shoe.jpeg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Stylish Shoe
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$20.99</span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Stylish Shoe">
                                <input type="hidden" name="Price" value="9.99">
                                <input type="hidden" name="imageFilename" value="shoe.jpeg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img21.jpeg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Leather sandals
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Leather sandals">
                                <input type="hidden" name="Price" value="18.99">
                                <input type="hidden" name="imageFilename" value="img21.jpeg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic8.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Green Cadet
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Green Cadet">
                                <input type="hidden" name="Price" value="10.99">
                                <input type="hidden" name="imageFilename" value="pic8.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
            ...
            <div class="flash-sale-section">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic9.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Red Hat
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Red Hat">
                                <input type="hidden" name="Price" value="13.99">
                                <input type="hidden" name="imageFilename" value="pic9.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic10.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Trendy Shorts
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Trendy Shorts">
                                <input type="hidden" name="Price" value="23.99">
                                <input type="hidden" name="imageFilename" value="pic10.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic11.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Stylish Hat
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$39.99</span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Stylish Hat">
                                <input type="hidden" name="Price" value="26.99">
                                <input type="hidden" name="imageFilename" value="pic11.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic12.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Cadet
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Cadet">
                                <input type="hidden" name="Price" value="16.99">
                                <input type="hidden" name="imageFilename" value="pic12.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic13.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Leather Hat
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$19.99</span>
                                        <span class="new-price">$13.99</span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Leather Hat">
                                <input type="hidden" name="Price" value="13.99">
                                <input type="hidden" name="imageFilename" value="pic13.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic14.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Basket
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Basket">
                                <input type="hidden" name="Price" value="8.99">
                                <input type="hidden" name="imageFilename" value="pic14.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/pic15.jpg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Earrings">
                                <input type="hidden" name="Price" value="9.99">
                                <input type="hidden" name="imageFilename" value="pic15.jpg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/im1.jpeg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Leather Trousers
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$20.99</span>
                                        <span class="new-price">$8.99</span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="leather Trousers">
                                <input type="hidden" name="Price" value="8.99">
                                <input type="hidden" name="imageFilename" value="im1.jpeg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img2.jpeg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Trendy Trousers
                                    </a>
                                    <div class="price">
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Trendy Trousers">
                                <input type="hidden" name="Price" value="7.99">
                                <input type="hidden" name="imageFilename" value="img2.jpeg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img3.jpeg"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Mixed pair
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$12.99</span>
                                        <span class="new-price">$6.99</span>
                            ...
                            <div class="product-cart-btn">
                                <form action="" method="post">
                                <input type="hidden" name="cloth" value="Mixed pair">
                                <input type="hidden" name="Price" value="6.99" >
                                <input type="hidden" name="imageFilename" value="img3.jpeg">
                                <input type="submit" class="product-btn" value="Add To Cart" name="cart">
                                </form>
                                <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                            </div>
            ...
            <div class="best-product-section">
                <div class="row g-4">
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img4.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img5.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img6.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Sweaters
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img7.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img8.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                                ...
                                <div class="product-description">
                                    <a href="product-info.html" class="product-details">Rainbow Sneakers
                                    </a>
                                    <div class="price">
                                        <span class="price-cut">$15.99</span>
                                        <span class="new-price">$7.99</span>
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img11.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img9.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img14.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img17.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img15.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img10.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="./assets/images/core/product-img/img16.jpeg"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
