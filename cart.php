...
}elseif(isset($_SESSION['id_view']) && $session == "INlogin"){

    // echo $session;
    header("location: login.php");

}elseif(!isset($_SESSION['id_view'])){
    $id_none = "INid";
    $session_none = "INlogin";
    // session_unset($_SESSION['id_view']);
    header("location: product-sidebar.php?session=$session_none&id=$id_none"); 
}elseif(isset($_SESSION['id_view']) && $session == "login"){
    // echo "Thank you God";
    if(isset($_POST['remove'])){
        $image_name = $_POST['image_name'];
        $client_id = $_POST['client_id'];

        $sql2 = $conn->prepare("delete from cart where client_id = ? and image_name = ?");
        $result2 = $sql2->execute([$client_id,$image_name]);
        if($result2){
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-user">
                            <a href="user-profile.php?session=<?php echo $session ?>&id=<?php echo $id_view  ?>">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                                        ...
                                        <path
                                            ...
                                            <!-- <img src="first.jpeg" alt="" style="width:50px;height: 50px;> -->
                                        </path>
                                       
                                    </svg>
                                    <?php
                                        $sql1 = $conn->prepare("select * from register where id = ?");
    ...
    <section class="product-cart product footer-padding">
        <div class="container">
                    ...
                    <tbody>
                        <tr class="table-row table-top-row">
                            ...
                            <!-- <td class="table-wrapper wrapper-total">
                                <div class="table-wrapper-center">
                                    <h5 class="table-heading">TOTAL PRICE</h5>
                                </div>
                            </td> -->
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                        ...
                        <tr class="table-row ticket-row">
                            <td class="table-wrapper wrapper-product">
                                <div class="wrapper">
                                    ...
                                    <div class="wrapper-content">
                                        <h5 class="heading"><?= $fetch['cloth'] ?></h5>
                                    </div>
                                </div>
                            </td>
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <h5 class="heading"><?= $fetch['price'] ?></h5>
                                </div>
                            </td>
                            <!-- <td class="table-wrapper">
                                <div class="table-wrapper-center">
                            ...
                            <td class="table-wrapper">
                                <div class="table-wrapper-center">
                                    <span>
                                        ...
                                        <input type="hidden" name="image_name" value="<?= $fetch['image_name'] ?>" >
                                        <input type="hidden" name="client_id" value="<?= $fetch['client_id'] ?>" >
            ...
            <div class="wishlist-btn cart-btn">
                <a href="empty-cart2.php?id_delete=<?php echo $id_view ?>" class="clean-btn">Clear Cart</a>
                <a href="#" class="shop-btn update-btn">Total is <?php echo $grand_total  ?></a>
                <a href="product-sidebar.php?session=<?php echo $session ?>&id=<?php echo $id_view ?>" class="shop-btn">Proceed to Shop</a>
            </div>
        </div>
    </section>
    <!--------------- cart-section-end---------------->
