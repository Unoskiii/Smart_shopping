    ...
    if($row <= 0 && !empty($email)){
        ...
        if(in_array($picActualExt,$allowed)){
            ...
            if($picSize < 10000000){
                ...
                $picDetsination = "register/".$picNameNew;
                $upload = move_uploaded_file($picTemp,$picDetsination);
                if($upload){
                    if(strlen($password) >= 6){

                        $sql1 = $conn->prepare("insert into register(fname,lname,email,phone,country,password,city,picture) values(?,?,?,?,?,?,?,?)");
                        $result1 = $sql1->execute([$fname,$lname,$email,$phone,$country,$hashP,$city,$picNameNew]);
                        if($result1){
                        ...
                        $error[] = "password 6 caharacter missing";
                    }
                }
            }else{
                // echo "invalid size";
            ...
            $error[] = "invalid type of profile attached";
        }
    }
}
                ...
                <div class="review-form">
                    ...
                    <div class=" account-inner-form">
                        ...
                        <div class="review-form-name">
                            ...
                            <input type="tel" id="phone" class="form-control" placeholder="+255766000000"  name="phone">
                        </div>
                    </div>
                    <div class="review-form-name">
                        <label for="country" class="form-label">Country</label>
                        <input type="text" id="country" class="form-control" placeholder="Enter your country" name="country">
                    ...
                    <div class="review-form-name address-form">
                        ...
                        <input type="password" id="address" class="form-control" placeholder="Enter your password" name="password">
                    </div>
                    <div class=" account-inner-form city-inner-form">
                        <div class="review-form-name">
                            <label for="city" class="form-label">Town / City</label>
                            <input type="text" id="city" class="form-control" placeholder="Enter your town" name="city">
                        ...
                        <div class="review-form-name">
                            ...
                            <input type="file" id="number" class="form-control" name="picture">
                        </div>
                    </div>
                    ...
                    if(isset($error)){
                        foreach($error as $error){
                            echo '<div class="review-form-name checkbox">
                            <div class="checkbox-item">
                                <!-- <input type="checkbox"> -->
                                <p class="remember">
                                <span class="inner-text" style="color:blue;margin-left: 147px; top: 100px">
                                    '.$error.'</span></p>
                            </div>
                        </div>';
                    ...
                    <div class="login-btn text-center">
                        ...
                        <input type="submit" value="Create an Account" name="C_account" class="shop-btn">
