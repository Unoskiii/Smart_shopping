...
if(!isset($_GET['session'])){
...
}elseif(!empty($id_view) && $session == "login"){
 ...
 if(isset($_POST['Update'])){
    ...
    $hashR = password_hash($Rpassword,PASSWORD_BCRYPT);

    $sql4 = $conn->prepare("select * from register where id = ?");
    $result4 = $sql4->execute([$id_view]);
    if($result4){
        $fetch4 = $sql4->fetch(PDO::FETCH_ASSOC);
        if(password_verify($Opassword,$fetch4['password'])){
            if($Rpassword == $password){

                $sql5 = $conn->prepare("update register set password = ? where id = ?");
                $result5 = $sql5->execute([$hashR,$id_view]);
                if($result5){
                    header("location: user-profile.php?session=$session&id=$id_view");
                }
            }else{
                $error_p[] = "passwords doesn`t match";
            }

        }else{
            $error_p[] = "wrong old password";
        }
    }
 }
        ...
        <div class="container">
            <div class="user-profile-section">
                <div class="dashboard-heading ">
                    <h5 class="dashboard-title">Tabs</h5>
                ...
                <div class="user-dashboard">
                    <div class="nav nav-item nav-pills  me-3" id="v-pills-tab" role="tablist"
                        ...
                        <div class="nav-link">
                            <a href="logout.php?session=<?php echo $session?>&id=<?php echo $id_view ?>">
                                <span>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="user-profile">
                                <div class="user-title">
                                    <p class="paragraph">Hello, <?php
                                    $sql3 = $conn->prepare("select * from register where id = ?");
                                    $result3 = $sql3->execute([$id_view]);
                                    ...
                                    <div class="row g-5">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="product-wrapper">
                                                ...
                                                <div class="wrapper-content">
                                                    <p class="paragraph">Items in the Cart</p>
                                                    <h3 class="heading"><?php
                                                    
                                                    $sql1 = $conn->prepare("select * from cart where client_id = ?");
                                            ...
                                            <div class="info-section">
                                                <div class="seller-info">
                                                    ...
                                                    <div class="info-list">
                                                        ...
                                                        $sql2 = $conn->prepare("select * from register where id = ?");
                                                        $result2 = $sql2->execute([$id_view]);
                            ...
                            <div class="row align-items-center">
                                    ...
                                    <div class="form-section">
                                        <form action="#" method="post">
                                            <div class="currentpass form-item">
                                                <label for="currentpass" class="form-label">Old Password</label>
                                                <input type="password" class="form-control" id="currentpass"
                                                    placeholder="current password" name="Opassword">
                                            </div>
                                        ...
                                        <div class="form-btn">
                                            <input type="submit" class="shop-btn" value="Update Password" name="Update"> <br><br>
                                             <!-- <a href="#" class="shop-btn">Upldate Password</a> -->
                                            <a href="#" class="shop-btn cancel-btn"><?php
                                            if(isset($error_p)){
                                                foreach($error_p as $error_p){
                                                    echo $error_p;
                                                }
                                            }
                                ...
                                <div class="col-lg-6">
                                    <div class="reset-img text-end">
                                        ...
                                        $result6 = $sql6->execute([$id_view]);
                                        $fetch5 = $sql6->fetch(PDO::FETCH_ASSOC);
                                        echo "register/".$fetch5['picture'] ?>" alt="reset">
                                    </div>
                                </div>
                            </div>
                        </div>
