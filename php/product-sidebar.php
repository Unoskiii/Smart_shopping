...
header("location: index.php");
   ...
   if(isset($_POST['cart']) && $session == "login"){
    $id = $_GET['id'];
    $imageFilename= $_POST['imageFilename'];
    $cloth = $_POST['cloth'];
    $price = $_POST['price'];
    $sql = $conn->prepare("select * from cart where image_name = ?");
    $result = $sql->execute([$imageFilename]);
    $row_image = $sql->rowCount();
    if($row_image <= 0){
        
        $sql1 = $conn->prepare("insert into cart(client_id,cloth,price,image_name) values(?,?,?,?)");
        $result1 = $sql1->execute([$id,$cloth,$price,$imageFilename]);
        if($result1){
            header("location: product-sidebar.php?session=$session&id=$id");
        }
    }else{
        $error_product[] = "The item is already in the cart";
    }
    
   }elseif(isset($_POST['cart']) && $session == "INlogin"){
    // $id_session2 = $id_session1;
    header("location: login.php");
    // $imageFilename= $_POST['imageFilename'];
    // $imageFilename= $_POST['idan'];
    // echo $imageFilename;
    // echo "how";
   }
...
if(isset($_POST['view'])){
    ...
    $id_se_view = $_SESSION['id'];
    header("location: cart.php?session=$session&id=$id_se_view");
}
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-cart">
                            <a href="cart.html" class="cart-item">
                                <span>(
                                    ...
                                    $sql2 = $conn->prepare("select * from cart where client_id = ?");
                                    $result2 = $sql2->execute([$id]);
                                    $row_cart = $sql2->rowCount();
                                    echo $row_cart;
                            ...
                            <div class="cart-submenu">
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-item">
                                            <div class="wrapper-img">
                                                <img src="assets/images/core/product-img/<?php echo $fetch3['image_name'] ?>"
                                                    alt="img">
                                            </div>
                                            <div class="wrapper-content">
                                                <h5 class="wrapper-title"><?php echo $fetch3['cloth'] ?></h5>
                                                <div class="price">
                                                    <p class="new-price"><?php  echo $fetch3['price'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <span class="close-btn">
                                            ...
                                            <form action="" method="post">
                                            <input type="hidden" name="name" value="<?= $fetch3['image_name'] ?>">
                                            <input type="hidden" name="id_re" value="<?= $fetch3['client_id'] ?>">
                                ...
                                <div class="cart-wrapper-section">
                                    ...
                                    <div class="wrapper-subtotal">
                                        ...
                                        <h5 class="wrapper-title">$<?php echo $grand_total  ?></h5>
                                    </div>
                                    <div class="cart-btn">
                                        <form action="" method="post">
                                        <input type="submit" class="shop-btn view-btn" value="View Cart" name="view">
                                        <!-- <input type="submit" class="shop-btn view-btn" value="Checkout Now" name="Check"> -->
                        ...
                        <div class="header-user">
                            <a href="user-profile.php?session=<?php echo $session ?>&id=<?php echo $id?>">
                                <span>
        ...
        <div class="header-bottom d-lg-block d-none">
            <div class="container">
                <div class="header-nav">
                    <!-- bre#div class="category-menu-section position-relative">
                    ...
                    <!-- <div class="header-vendor-btn">
                        <a href="become-vendor.html" class="shop-btn">
                            <span class="list-text shop-text">Become Vendor</span>
                            <!-- <input type="submit" value="Become Vendor" > -->
                            <!-- <span class="icon"> -->
                ...
                <div class="col-lg-3">
                    <div class="sidebar" data-aos="fade-right">
                        ...
                        <div class="sidebar-shop-section">
                            ...
                            <a href="#" class="shop-btn deal-btn">Contact us 0766531122</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="product-sidebar-section" data-aos="fade-up">
                        <div class="row g-5">
                            <div class="col-lg-12">
                                <div class="product-sorting-section">
                                    <div class="result">
                                        ...
                                        <p style="color:black;"><span><?php if(isset($error_product)){foreach($error_product as $error_product) {
                                            echo $error_product;
                                        } 
                                    }?></span></p>
                                    </div>
                            ...
                            <!-- <form action="" id="imageForm1" method="post"> -->
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <!-- <form action="" id="imageForm1" method="post"> -->
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/img20.jpeg"
                                            alt="product-img" id="myImage">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Black Boot
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                        <form action="" method="post">
                                        <input type="hidden" name="cloth" value="Black Boot">
                                        <input type="hidden" name="price" value="15.99">
                                        <input type="hidden" name="imageFilename" id="imageFilenameInput" value="img20.jpeg" >
                                        <input type="submit" value="Add to cart" class="product-btn" name="cart">
                                        </form>
                            ...
                            <!-- </form> -->
                            <!-- <script>
                                $("#imageForm1").submit(function(event){
                                    var imagePath = document.getElementById("myImage").src;
                                    var filename = imagePath.substring(imagePath.lastIndexOf('/') + 1);
                                    alert(imagePath);

                                    // Set the filename to the hidden input in the form
                                    $('#imageFilenameInput').val(filename);
                                });
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/img18.jpeg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-cart-btn">
                                        <form action="" method="post">
                                        <input type="hidden" name="cloth" value="Black Suit">
                                        <input type="hidden" name="price" value="22.99">
                                        <input type="hidden" name="imageFilename" value="img18.jpeg">
                                        <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                        </form>
                                        <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/img19.jpeg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Cow Boy
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                        <form action="" method="post">
                                        <input type="hidden" name="cloth" value="Cow Boy">
                                        <input type="hidden" name="price" value="11.99">
                                        <input type="hidden" name="imageFilename" value="img19.jpeg">
                                        <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                        </form>
                                        <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou1.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Crazy Jeans
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                     <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Crazy Jeans">
                                    <input type="hidden" name="price" value="11.99">
                                    <input type="hidden" name="imageFilename" value="trou1.jpg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou2.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Black Jeans
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Black Jeans">
                                    <input type="hidden" name="price" value="8.99">
                                    <input type="hidden" name="imageFilename" value="trou2.jpg">   
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                     <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou3.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Star Jeans
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Star Jeans">
                                    <input type="hidden" name="price" value="16.99">
                                    <input type="hidden" name="imageFilename" value="trou3.jpg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="product-deal-section" data-aos="fade-up">
                                    <h5 class="wrapper-heading">Get the best deal for Fashions</h5>
                                    <input type="submit" value="Order" class="shop-btn">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou4.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Pair Trousers
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Pair Trousers">
                                    <input type="hidden" name="price" value="16.99">
                                    <input type="hidden" name="imageFilename" value="trou4.jpg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou5.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Dark Jeans
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Dark Jeans">
                                    <input type="hidden" name="price" value="20.99">
                                    <input type="hidden" name="imageFilename" value="trou5.jpg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                     <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou6.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Red Cadet
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Red Cadet">
                                    <input type="hidden" name="price" value="16.99">    
                                    <input type="hidden" name="imageFilename" value="trou6.jpg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/trou7.jpg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <input type="hidden" name="imageFilename" value="trou7.jpg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/im9.jpeg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Air max
                                            </a>
                                            <div class="price">
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Air max">
                                    <input type="hidden" name="price" value="26.99">
                                    <input type="hidden" name="imageFilename" value="im9.jpeg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="./assets/images/core/product-img/img24.jpeg"
                                            alt="product-img">
                                        <div class="product-cart-items">
                                    <!-- <a href="#" class="cart cart-item">
                                        <span>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="product-info.html" class="product-details">Lady sandals
                                            </a>
                                            <div class="price">
                                                <span class="price-cut">$29.99</span>
                                                <span class="new-price">$16.99</span>
                                    ...
                                    <div class="product-cart-btn">
                                    <form action="" method="post">
                                    <input type="hidden" name="cloth" value="Lady sandals">
                                    <input type="hidden" name="price" value="16.99">
                                    <input type="hidden" name="imageFilename" value="img24.jpeg">
                                    <input type="submit" value="Add to Cart" class="product-btn" name="cart">
                                    </form>
                                    <!-- <a href="cart.html" class="product-btn">Add To Cart</a> -->
                                    </div>
